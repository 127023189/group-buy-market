...
public class ActivityRepository extends AbstractRepository implements IActivityRepository {
    ...
    public SCSkuActivityVO querySCSkuActivityBySCGoodsId(String source, String channel, String goodsId) {
        SCSkuActivity scSkuActivityRes = new SCSkuActivity();
        scSkuActivityRes.setSource( source);
        scSkuActivityRes.setChannel( channel);
        scSkuActivityRes.setGoodsId( goodsId);

        SCSkuActivity scSkuActivity = skuActivityDao.querySCSkuActivityBySCGoodsId(scSkuActivityRes);
    ...
    public GroupBuyActivityDiscountVO queryGroupBuyActivityDiscountVO(Long activityId) {
        ...
        GroupBuyActivityDiscountVO.GroupBuyDiscount groupBuyDiscount = GroupBuyActivityDiscountVO.GroupBuyDiscount.builder()
                ...
                .discountType(DiscountTypeEnum.get(groupBuyDiscountRes.getDiscountType().intValue()))
