...
public class MarketNode extends AbstractGroupBuyMarketSupport<MarketProductEntity, DefaultActivityStrategyFactory.DynamicContext, TrialBalanceEntity>{
    ...
    protected void multiThread(MarketProductEntity requestParameter, DefaultActivityStrategyFactory.DynamicContext dynamicContext) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        FutureTask<GroupBuyActivityDiscountVO> groupBuyActivityDiscountVOFutureTask  = new FutureTask<GroupBuyActivityDiscountVO>(queryGroupBuyActivityDiscountVOThreadTask);
        ...
        FutureTask<SkuVO> skuVOFutureTask = new FutureTask<SkuVO>(querySkuVOFromDBThreadTask);
    ...
    public StrategyHandler<MarketProductEntity, DefaultActivityStrategyFactory.DynamicContext, TrialBalanceEntity> get(MarketProductEntity requestParameter, DefaultActivityStrategyFactory.DynamicContext dynamicContext) throws Exception {
        // 不存在配置的拼团活动，走异常节点
        if(dynamicContext.getSkuVO() == null || dynamicContext.getGroupBuyActivityDiscountVO() == null || null == dynamicContext.getDeductionPrice()){
            return errorNode;
        }
        return tagNode;
    }
